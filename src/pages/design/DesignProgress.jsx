...
import topDesign from "../../assets/portfolio/design/design.avif?url";
        ...
        <div className="flex flex-col items-center space-y-32 lg:space-y-48 justify-center p-4">
          <SectionWrapper>
            <TextContent>
              ...
              >
                Creative District & Industry Support
              </motion.h1>
              <motion.p
              ...
              >
                ...
                meets opportunity. Purpose-built for sectors like fashion,
                architecture, interior, and product design, this environment
                supports both new and established talent.
              </motion.p>
              <motion.p
                initial={{ opacity: 0, x: -50 }}
                whileInView={{ opacity: 1, x: 0 }}
              ...
              >
                ...
                fosters collaboration, innovation, and growth. The space is
                tailored to help creative brands scale, experiment, and lead in
          ...
          <SectionWrapper reverse>
            ...
            <TextContent>
              ...
              >
                Innovation, Culture & Community Growth
              </motion.h1>
              <motion.p
                initial={{ opacity: 0, x: 50 }}
                whileInView={{ opacity: 1, x: 0 }}
              ...
              >
                ...
                Through incubator programs, educational partnerships, and a rich
                calendar of workshops, exhibitions, and events, we empower
                creatives to grow and connect.
              </motion.p>
              <motion.p
                initial={{ opacity: 0, x: 50 }}
                whileInView={{ opacity: 1, x: 0 }}
              ...
              >
                ...
                meet—driving the evolution of design thinking and cultural
          ...
          >
            <motion.div
              className="bg-white/20 backdrop-blur-lg space-y-6 rounded-3xl p-8 sm:p-12 shadow-2xl border border-white/10"
              whileHover={{ scale: 1.02 }}
              transition={{ type: "spring", stiffness: 400, damping: 10 }}
            >
              <h2 className="text-white sm:text-3xl md:text-3xl lg:text-4xl font-bold font-bebasneue">
                Shape the Future of Design with Divine Group
              </h2>
              <p className="text-xl sm:text-2xl text-gray-200 mb-8 ">
                Whether you're a startup, established studio, educator, or
