          ...
          <SectionWrapper>
            ...
            <ImageContent>
              <motion.div
                ...
                viewport={{ once: false, margin: "-100px" }}
                transition={{ duration: 0.8 }}
                className="w-[18rem] h-[18rem] sm:w-[25rem] sm:h-[25rem] md:w-[28rem] md:h-[28rem] lg:w-[30rem] lg:h-[30rem] rounded-full border-4 border-white/50 shadow-xl"
              >
                <img
                  src={divineGroup}
                  alt=""
          ...
          <SectionWrapper reverse>
            <ImageContent>
              <motion.div
                ...
                viewport={{ once: false, margin: "-100px" }}
                transition={{ duration: 0.8 }}
                className="w-[18rem] h-[18rem] sm:w-[25rem] sm:h-[25rem] md:w-[28rem] md:h-[28rem] lg:w-[30rem] lg:h-[30rem] rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center shadow-xl"
              >
                <img
                  src={logo}
                  alt="Company Logo"
